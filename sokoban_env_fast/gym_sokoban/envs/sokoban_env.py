...
from sokoban_env_fast.gym_sokoban import logger
...
class SokobanEnv(gym.Env):
    ...
    def seed(self, seed=None):
        # INFO(maciek): what guarantees do we want from this?
    ...
    def load_surfaces():
     ...
     # INFO(lukaszkucinski): added functionality (for speed purpose)
