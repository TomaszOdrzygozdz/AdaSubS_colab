...
from sokoban_env_fast.gym_sokoban.envs.sokoban_env import SokobanEnv
...
class SokobanEnvFast(gym.Env):
    ...
    def __init__(self,
                 ...
                 # TODO(pm): currently penalty_box_off_target is implicitly = - reward_box_on_target
        ...
        # TODO(pm): This is only for generation. Refactor!
    ...
    # TODO(łk): refactor together with _slave_env. What should be the meaning of _seed
    ...
    def clone_full_state(self):
        # TODO(pm): This should be done more elegantly
